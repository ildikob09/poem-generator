...
function generatePoem(event) {
  ...
  let context = `you are an AI who is a poet. User instructions: You have to sign the poem as "ShecodesAI" underneath the poem using <strong> element to display and use <br /> to separate the lines`;
